...
for test_index in [1, 2, 3, 4, 5, 6, 7, 8]:
    ...
    # for benign class
    plot_all_shap_values(shap_values[0],test_hydrogens_normalized,"./plots/RF/control_tumor_shap_control_all_spectrum_test_fold_"+str(test_index))
    plot_top_k_shap_values(shap_values[0],test_hydrogens_normalized, 100, "./plots/RF/control_tumor_shap_control_top_k_spectrum_test_fold_"+str(test_index))
    ...
    plot_all_shap_values(shap_values[1],test_hydrogens_normalized,"./plots/RF/control_tumor_shap_tumor_all_spectrum_test_fold_"+str(test_index))
    plot_top_k_shap_values(shap_values[1],test_hydrogens_normalized, 100, "./plots/RF/control_tumor_shap_tumor_top_k_spectrum_test_fold_"+str(test_index))
