...
for test_index in [1, 2, 3, 4, 5, 6, 7, 8]:
    ...
    # for control class
    plot_all_shap_values(shap_values[0],test_hydrogens_normalized,"./control_tumor_shap_control_all_spectrum_test_fold_"+str(test_index))
    plot_top_k_shap_values(shap_values[0],test_hydrogens_normalized, 100, "./control_tumor_shap_control_top_k_spectrum_test_fold_"+str(test_index))
    # for aggressive class
    plot_all_shap_values(shap_values[1],test_hydrogens_normalized,"./control_tumor_shap_tumor_all_spectrum_test_fold_"+str(test_index))
    plot_top_k_shap_values(shap_values[1],test_hydrogens_normalized, 100, "./control_tumor_shap_tumor_top_k_spectrum_test_fold_"+str(test_index))
